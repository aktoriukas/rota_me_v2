    ...
    render() {
        ...
        return (
            <div className='new-worker form'>
                ...
                <form>
                    <div>
                        <input value={name} placeholder='name' className='input' type='text' name='name' onChange={(e) => {
                            this.setName(e.target.value)
                        }} />
                    </div>
                    <div>
                        <input value={role} placeholder='role' className='input' type='text' name='role' onChange={(e) => {
